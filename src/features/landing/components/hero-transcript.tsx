...
// Persistent word spans prevent transcript reflow during the opacity reveal.
...
const ConversationTranscript = ({
  ...
  // Keep the shared greeting complete when conversations change.
...
export const HeroTranscript = () => {
  ...
  // Skip the conversation crossfade until there is something to cross from.
  ...
  // Reset Activity-preserved demo state when the route is hidden.
  useLayoutEffect(
    () => () => {
